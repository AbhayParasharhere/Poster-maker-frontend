...
export default function SignUp() {
  ...
  function submitForm(formValues) {
    if (
      ...
      setError(true);
      document.querySelector(".signup--error-text").innerHTML =
      ...
      setError(true);
      document.querySelector(".signup--error-text").innerHTML =
        "Your email or password are not the same";
      return;
    }
    ...
    const fetchData = async () => {
      try {
        ...
        setError(true);
        document.querySelector(".signup--error-text").innerHTML = error.message;
      }
    };
