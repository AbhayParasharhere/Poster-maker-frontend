    ...
    return (
      <div className="main-poster-container--2">
        ...
        <div className="text-info-container--2">
          <p className="main-poster-tagline--2">
            Secure your future with life insurance!
          </p>
          <p className="poster-tagline-1--2">
            Life is unpredictable, but your financial security doesn't have to
            be
          </p>
          <p className="poster-tagline-2--2">
            Protect your loved ones and invest in their future with life
            insurance today
          </p>
