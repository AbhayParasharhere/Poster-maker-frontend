  ...
  <div className="Poster-5-container--7">
    <div className="Poster5--main-container">
        <div className="lleft-container">
            ...
            <p className="text-5--7"><span className="text-q"></span>BANK LOANS</p>
            <p className="text-6--7">Must be repaid even if something happens<br /> to you, such as becoming critically<br />ill or disabled</p>
